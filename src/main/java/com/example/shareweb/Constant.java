...
public interface Constant {
    ...
    String 获取当天数据 = "https://quotes.sina.cn/cn/api/jsonp_v2.php/=/CN_MarketDataService.getKLineData?symbol=%s&scale=240&ma=no&datalen=500";
    ...
    String 转债详情页面 = "https://money.finance.sina.com.cn/bond/quotes/%s.html";
}
